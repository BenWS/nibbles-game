...
class Container:
  ...
  class Element:
    def __init__(self, content, id=None, parent=None):
  ...
  def __init__(self,parent, min_height=0,min_width=0, positioning='GROUPED', margin=(0,0,0,0)):
  ...
  def add_child(self,child, id=None):
    # surface.parent = self
    child_element = Container.Element(child,id=id)
